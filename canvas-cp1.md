...
| **7. Phân công có tên** | **Mai Văn Trường:** product owner, spec và prototype flow. **Nguyễn Viết Đức:** phân tích khảo sát, evidence và golden set. **Hồ Ngọc Mai:** thiết kế prompt/phản hồi, UX và tổ chức validation. **Dương Văn Thành:** tích hợp AI, code, logging và chuẩn bị demo. |
